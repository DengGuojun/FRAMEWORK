...
public abstract class DBExecutor {
	...
	public int getTotalRecordResult(String sql, List<String> condList, List<String> paramList, DBObject db)
			throws SQLException {
		sql = sql + SqlKit.condList2QueryStmt(condList, true);
	...
	public int getTotalRecordResult(String sql, List<String> paramList, DBObject db) throws SQLException {
		int result = 0;
		String sqlCount = SqlKit.getCountSql(sql);
	...
	public <E> List<E> getRecordListResult(String sql, String orderQuery, List<String> condList, List<String> paramList,
			Class<E> clazz, PageBean pageBean, DBObject db) throws SQLException, Exception {
		sql = sql + SqlKit.condList2QueryStmt(condList, true);
		sql = sql + " " + orderQuery;
	...
	public <E> List<E> getRecordListResult(String sql, String orderQuery, List<String> condList, List<String> paramList,
			Class<E> clazz, DBObject db) throws SQLException, Exception {
		sql = sql + SqlKit.condList2QueryStmt(condList, true);
		sql = sql + " " + orderQuery;
