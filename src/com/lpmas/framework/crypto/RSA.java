package com.lpmas.framework.crypto;
...
public class RSA {
	...
	public static void createKeyPair(String filePath) throws Exception {
		...
		FileKit.writeFile(filePath + PUBLIC_KEY + ".key", getPublicKeyContent(keyMap), Constants.SYSTEM_ENCODING);
		FileKit.writeFile(filePath + PRIVATE_KEY + ".key", getPrivateKeyContent(keyMap), Constants.SYSTEM_ENCODING);
	}
