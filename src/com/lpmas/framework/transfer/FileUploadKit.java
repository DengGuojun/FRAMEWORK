...
public class FileUploadKit {
	...
	private String characterEncoding = Constants.ENCODING_UNICODE;
	...
	private String getExtensionFileName(String fileName) {
		...
		if (lowerExtensionFileName) {
			extensionFileName = extensionFileName.toLowerCase();
		}
		return extensionFileName;
	}

	private String getFileName(String outputFileName, String extensionFileName) {
		return outputFileName + "." + extensionFileName;
	}
}
