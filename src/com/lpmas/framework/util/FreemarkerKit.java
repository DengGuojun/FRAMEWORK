...
public class FreemarkerKit {
	...
	private String defaultCharset = Constants.ENCODING_UNICODE;
	...
	public Configuration getConfiguration() {
		...
		cfg.setEncoding(Locale.CHINA, defaultCharset);
	...
	public boolean generateFile(HashMap<String, Object> contentMap, Template template, String filePath)
		...
		Writer writer = new OutputStreamWriter(new FileOutputStream(file), defaultCharset);
	...
	public boolean outputContent(HashMap<String, Object> contentMap, Template template, HttpServletResponse response)
			throws Exception {
		Writer out = new OutputStreamWriter(response.getOutputStream(), defaultCharset);
		template.process(contentMap, out);
		out.flush();
		out.close();
